  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-500 mb-4">
          Use this calculator to estimate the monthly repayments and total amount payable.
        </p>
        ...
        {/* Loan Amount */}
        <div className="mb-6">
          <label className="text-gray-700 font-medium mb-2 block">Expected loan amount</label>
          <div className="flex items-center border-b border-gray-300 pb-2">
            <span className="text-black font-semibold mr-4">AED</span>
            <input
              type="number"
        ...
        {/* Repayment Term */}
        <div className="mb-6">
          <label className="text-gray-700 font-medium mb-2 block">Repayment term</label>
          <button
            onClick={() => setShowTermModal(true)}
            className="w-full flex items-center justify-between border-b border-gray-300 pb-3"
          >
